          ...
          <div id="directory-listing" style={{ maxWidth: '100%', overflow: 'hidden' }}>
            <div id="Listingg" style={{ 
              ...
              <h1 ref={titleRef} style={{ 
                ...
                lineHeight: '1.2',
                marginBottom: '15px', marginTop: '100px'
              }}>
              ...
              <div id="kjk1" ref={tableRef} style={{ 
                display: 'flex', 
                justifyContent: 'center', 
                alignItems: 'center',
                width: '100%',
                padding: '0 20px',
                marginTop: '10px', position: 'relative', top: selectedCategory === 'Broker'
                ? window.innerWidth <= 500
                  ? '-700px'
                  : '-900px'
                : '0px',
                marginBottom: selectedCategory === 'Broker' ? '-1800px' : '0px'
              }}>
